...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Phoebe', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '找自由的路上', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://phoebe210.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Phoebe, 博客', // 网站关键词 英文逗号隔开
